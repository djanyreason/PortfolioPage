...
const Name = ({ variant }) => {
  const theme = createTheme({
    typography: {
      ...
      h2: {
        fontSize: '1.25rem',
        '@media (min-width:265px)': { fontSize: '1.50rem' },
        '@media (min-width:295px)': { fontSize: '1.75rem' },
        '@media (min-width:320px)': { fontSize: '2.00rem' },
        '@media (min-width:350px)': { fontSize: '2.25rem' },
        '@media (min-width:380px)': { fontSize: '2.50rem' },
        '@media (min-width:410px)': { fontSize: '2.75rem' },
